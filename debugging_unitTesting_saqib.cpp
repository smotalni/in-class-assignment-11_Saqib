...
string test = "rryryryryry";
cout <<"now testing rryryryryry\n"<<is_word_in_tree(test)<<endl;
cout<<"Adding string to tree\n"<<add_word_to_tree(test)<<endl;
    ...
    if (add_word_to_tree(test)==true)
    {
        cout<<"The word was correctly added"<<endl;
    }
    else
    {
        cout<<"The word wdas not added"<<endl;    
    }
